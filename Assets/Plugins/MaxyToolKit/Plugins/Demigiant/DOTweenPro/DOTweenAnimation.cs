...
//            }
...
#if true // UI_MARKER
                    tween = DG.Tweening.DOTweenModuleUGUI.DOAnchorPos3D((RectTransform)target, endValueV3, duration, optionalBool0);
#else
                    tween = ((Transform)target).DOMove(endValueV3, duration, optionalBool0);
#endif
                    break;
            ...
            case AnimationType.FillAmount:
                tween = DG.Tweening.DOTweenModuleUGUI.DOFillAmount((Image)target, endValueFloat, duration);
                break;
#endif
            case AnimationType.Color:
                ...
                case TargetType.Image:
                    tween = DG.Tweening.DOTweenModuleUGUI.DOColor((Graphic)target, endValueColor, duration);
                    break;
                case TargetType.Text:
                    tween = DG.Tweening.DOTweenModuleUGUI.DOColor((Text)target, endValueColor, duration);
                    break;
#endif
#if false // TK2D_MARKER
                case TargetType.tk2dTextMesh:
...
#if true // UI_MARKER
                case TargetType.Image:
                    tween = DG.Tweening.DOTweenModuleUGUI.DOFade((Graphic)target, endValueFloat, duration);
                    break;
                case TargetType.Text:
                    tween = DG.Tweening.DOTweenModuleUGUI.DOFade((Text)target, endValueFloat, duration);
                    break;
                case TargetType.CanvasGroup:
                    tween = DG.Tweening.DOTweenModuleUGUI.DOFade((CanvasGroup)target, endValueFloat, duration);
                    break;
#endif
#if false // TK2D_MARKER
                case TargetType.tk2dTextMesh:
            ...
            case AnimationType.Text:
                ...
                switch (targetType) {
                case TargetType.Text:
                    tween = DG.Tweening.DOTweenModuleUGUI.DOText((Text)target, endValueString, duration, optionalBool0, optionalScrambleMode, optionalString);
                    break;
                }
#endif
#if false // TK2D_MARKER
