    ...
    internal static class WindowScopeServices
    {
        ...
        public static void Register(ServiceScope scope = null)
        {
            ...
            else if (_serviceScope == null)
            {
                ...
                {
                    Debug.LogError("[MaxyMCP] Root service provider is not initialized.");
                }
            }
        }
        ...
        private static void OnBeforeAssemblyReload()
        {
            ...
            {
                Debug.LogError($"[MaxyMCP] Error disposing window scope: {ex}");
            }
        }
        ...
        public static void Reset()
        {
            ...
            {
                Debug.LogError($"[MaxyMCP] Error disposing window scope during reset: {ex}");
            }
            finally
            {
                _serviceScope = null;
